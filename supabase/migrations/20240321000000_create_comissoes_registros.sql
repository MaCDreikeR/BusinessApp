...
CREATE INDEX idx_comissoes_registros_usuario ON comissoes_registros(usuario_id);
CREATE INDEX idx_comissoes_registros_estabelecimento ON comissoes_registros(estabelecimento_id);
CREATE INDEX idx_comissoes_registros_data ON comissoes_registros(data);
...
COMMENT ON COLUMN comissoes_registros.valor IS 'Valor da comissão paga';
